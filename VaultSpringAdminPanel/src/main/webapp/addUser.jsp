...
function validateForm() {
    var firstname = document.forms["myform"]["name1"].value;
    ...
    var lastname = document.forms["myform"]["name2"].value;
    ...
    var teamname = document.forms["myform"]["teamname1"].value;
...
<body>
	...
	<%=session.getAttribute("userid")%>
 	...
 	<div class="container">
		<h1 class="well">Add User Details</h1>
